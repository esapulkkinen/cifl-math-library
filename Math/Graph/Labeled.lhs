...
>
>instance (Monad m, Ord e, GraphMonoid mon Bool) => GraphMonad (ReaderT (LGraph lbl mon e) m) e where
...
>
>instance (Monad m, Ord e, ReversibleGraphMonoid mon Bool) => ReversibleGraphMonad (ReaderT (LGraph lbl mon e) m) e where
>   ginverse = liftReaderLGraph . ginverse
>   greversibleLinks = liftReaderLGraph greversibleLinks

>instance (Monad m, Ord e, GraphMonoid mon Bool) => LabeledGraphMonad (ReaderT (LGraph lbl mon e) m) lbl e where
>   glabelOf e = ask >>= (return . (`labelOf` e))
>   gfind lbl = ask >>= (return . (`elementByLabel` lbl))


>instance (Monad m, Ord e, GraphMonoid mon Bool) => LabeledGraphMonad (InLGraphM mon lbl e m) lbl e where
...
>
>
>instance (Ord e, Monad m, GraphMonoid mon Bool) => GraphMonad (InLGraphM mon lbl e m) e where
...
>
>instance (Ord e, Monad m, ReversibleGraphMonoid mon Bool) => ReversibleGraphMonad (InLGraphM mon lbl e m) e where
