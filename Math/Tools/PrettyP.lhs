...
>module Math.Tools.PrettyP (PpShow(..), LeveledPpShow(..), module Pretty, (<>), render, pPrint,
>		 enclose, parenthesize, bracketize, pp_list, render132,
>                alternativitize, verticalize,
>		 PpShowF(..)) where
...
instance (PpShowF f, PpShow a) => PpShow (f a) where
	  pp x = ppf x
